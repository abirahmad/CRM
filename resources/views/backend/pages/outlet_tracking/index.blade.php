...
<div class="row">
    <div class="col-xl-12 xl-100">
        <h4 class="mb-3 mt-2 float-left mt-3">Outlet Tracking</h4>
        ...
        <div class="mt-3">
            <form class="form-inline">
              <div class="form-group mx-sm-3 mb-2">
                <label for="inputPassword2">Line &nbsp;&nbsp;</label>
                 <select class="form-control" name="lines" id="lines">
              ...
              <div class="form-group mx-sm-3 mb-2">
                <label for="inputPassword2">Route &nbsp;&nbsp;</label>
                <select class="form-control" name="route_id" id="routes"></select>
              </div>
              <div class="form-group mx-sm-3 mb-2">
                <label for="inputPassword2">Outlet Type &nbsp;&nbsp;</label>
    ...
    //   getMarkerData();
      ...
      function getRouteList(){
          ...
          .then(function(res){
             ...
             routes = res.data;
              let outletROuteString = "<option value=''>Select a route</option>";
      ...
      function getBusinessTypeList(){
          ...
          .then(function(res){
              ...
              let outletTypeString = "<option value=''>Select a business type</option>";
       ...
       function  getMarkerData(){
          ...
          let intlineid = $("#lines").val();
          
          if(typeof typeID == 'undefined' || typeID.length === 0) typeID = 0;
          if(typeof routeID == 'undefined' || routeID.length === 0) routeID = 0;
          if(typeof intlineid == 'undefined' || intlineid.length === 0) intlineid = 0;
          
          console.log('routeID', routeID);
          console.log('typeID', typeID);
          console.log('intlineid', intlineid);
           
          axios.get(`http://api2.akij.net:8054/api/AFBLOutletLocationStatus/GetAFBLOutletLocationOutletRegistrationData?intunitid=2&introuteid=${routeID}&intbusinesstypeid=${typeID}&intlineid=${intlineid}`)
