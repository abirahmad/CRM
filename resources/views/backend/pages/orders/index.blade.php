            ...
            <div class="box box-primary" id="accordion">
                ...
                <div id="collapseFilter" aria-expanded="true">
                    <div class="box-body">
                        ...
                        {!! Form::open(['url' => action('Backend\OrdersController@index'), 'method' => 'get', 'id' => 'projects_filter_form' ]) !!}
                     <div class="row">
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('created_by',__('Ordered By') . ':') !!}
                     ...
                     <div class="col-md 3">
                         <div class="form-group">
                              <label>Status</label>
                                <select class="form-control" id="status" style="width:50%" >
...
$('#projects_filter_form #site_id, #projects_filter_form #created_by, #projects_filter_form #status').change(function() {
    ...
    order_table = $('table#orders_table').DataTable({
        dom: 'Blfrtip',  
        processing: true,
        serverSide: true,
        searchable:true,
