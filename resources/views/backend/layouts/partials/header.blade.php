...
<div class="main-header-right row">
    ...
    <ul class="nav-menus">
        ...
        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle" src="{{ asset('public/backend/images/dashboard/user.png') }}" alt="header-user">
